<div>
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button class="btn btn-sm btn-primary shadow-md mr-2" wire:click="$dispatchTo('dashboard.projects.detail', 'show')">
    ...
    <div class="intro-y grid grid-cols-12 gap-6 mt-5">
        ...
        @foreach($projects as $project)
            <div wire:key="{{ $project->id }}" class="intro-y col-span-12 md:col-span-6 xl:col-span-3 2xl:col-span-2 box">
                    ...
                    <div>
                        ...
                        <div id="dropdownContent-project-{{ $project->id }}" class="dropdown-menu hidden">
                            <ul class="dropdown-content">
                                <li>
                                    <button class="dropdown-item" wire:click="$dispatchTo('dashboard.projects.detail', 'show', { project: {{ $project->id }} } )" >
                                ...
                                <li>
                                    <button wire:click="$dispatchTo('dashboard.projects.detail', 'delete', { project: {{ $project->id }} })"
    ...
    <livewire:dashboard.projects.detail />
</div>
